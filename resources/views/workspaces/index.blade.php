...
<div class="min-h-screen">
    ...
    <x-navigation/>
    <div class="lg:pl-72">
        <x-topbar subtitle="Collaboration" title="Workspaces">
            <x-slot name="actions">
